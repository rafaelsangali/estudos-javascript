...
// utilizado para percorrer uma array
  persons.forEach((persons, index) => {
     // console.log(`${index} -  ${persons.name}`)
  });
//--------------------------------------------------------------------------------
...
//--------------------------------------------------------------------------------
// Filter, filtra informações criando um novo array

const personInactive = persons.filter((persons) => {
  return !persons.isActive;
});

// console.log(personInactive)

const personLivesArizona = persons.filter((persons) => {
  return persons.address.toLowerCase().indexOf('arizona') != -1;

});

// console.log(personLivesArizona);
//--------------------------------------------------------------------------------
// para remover uma posição dentro de um array
//persons.splice(parametro, posição)
//--------------------------------------------------------------------------------
